...
struct RoundedRectProgress: InsettableShape {
    ...
    func path(in rect: CGRect) -> Path {
        ...
        let bottomRightArcCenter: CGPoint = CGPoint(
            x: bottomRightCornerWithInset.x - cornerRadius, y: bottomRightCornerWithInset.y - cornerRadius)
        let bottomLeftArcCenter: CGPoint = CGPoint(
